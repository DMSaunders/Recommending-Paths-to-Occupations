...
image:pandas.jpg[pandas,200,100] image:scikit.png[scikit,200,100] image:matplot.png[matplot,200,100] image:Jupyter-logo.png[jupyter,100,100] image:ec2.png[ec2,200,100]
...
image::galv_capstone.jpeg[process flow,500,600]
...
image:ROC_occp15_tunedrf_edu.png[roc1,300,300] image:ROC_occp15_tunedrf_freewill.png[roc2] 
