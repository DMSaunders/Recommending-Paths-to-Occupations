...
image:pandas.jpg[pandas,200,150] image:scikit.png[scikit,200,100] image:matplot.png[matplot,250,100] image:Jupyter-logo.png[jupyter,100,100] image:ec2.png[ec2,200,100]
