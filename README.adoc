...
image:pandas.jpg[pandas,100,75] image:scikit.png[scikit,100,50] image:matplot.png[matplot,125,50] image:Jupyter-logo.png[jupyter,100,100] image:ec2.png[ec2,200,100]
